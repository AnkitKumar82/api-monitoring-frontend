    ...
    <div>
      ...
      <main
        style={{
          ...
          // background:"radial-gradient(circle at 15% 20%, #7c3aed55 0%, transparent 35%), radial-gradient(circle at 85% 75%, #2563eb55 0%, transparent 40%), radial-gradient(circle at 50% 100%, #14b8a655 0%, transparent 30%), linear-gradient(135deg, #edf4ff, #f8fbff);"
        }}>
        <Home />
        <CustomAlert />
        <Script
